...
function loadStatsPage(){
	...
	var wins = 0
	var loss = 0
	for(var row_counter = 0 ; row_counter < table.rows.length; row_counter++){
		if (table.rows[row_counter].cells.length > 4){
			// table.rows[row_counter].cells[2].style.backgroundColor = 'red'
			// table.rows[row_counter].cells[3].style.backgroundColor = 'blue'
			// table.rows[row_counter].cells[4].style.backgroundColor = 'green'
			buff_score = parseInt(table.rows[row_counter].cells[2].innerHTML)
			opp_score = parseInt(table.rows[row_counter].cells[3].innerHTML)
			opp_name = table.rows[row_counter].cells[1].innerHTML
			if (buff_score > opp_score){
				table.rows[row_counter].cells[4].innerHTML='Sko Buffs'
				wins++
			} else{
...
function loadPlayersPage(){
	...
	for(var i = 0; i < players.length; i++){
		...
		link.href = '#'
		link.innerHTML = players[i].name
		link.setAttribute('onclick','switchPlayers('+i+')')
